...
struct SPhysxAndNodePair {
	...
	scene::ISceneNode *SceneNode, *SceneNode2;
...
SPhysxAndNodePair* createBullet(IPhysxManager* physxManager, scene::ISceneManager* smgr, video::IVideoDriver* driver, const core::vector3df& pos, f32 radius = 2.0f, f32 density = 10.0f, core::vector3df* initialVelocity = NULL);
SPhysxAndNodePair* createBulletFromCamera(IPhysxManager* physxManager, scene::ISceneManager* smgr, video::IVideoDriver* driver, scene::ICameraSceneNode* camera, f32 radius = 2.0f, f32 density = 10.0f);
